...
This branch tracks `1.0.0-RC.1`, which needs macOS 27. Build with the **Xcode 27**
...
binary dependency, building against `1.0.0-RC.1` by default:
...
|---|---|---|---|
| `LOCALLM_SDK_VERSION` | No | `1.0.0-RC.1` | Read by this app's `Package.swift` and `Components`' own — set it to build against a different published release. |
